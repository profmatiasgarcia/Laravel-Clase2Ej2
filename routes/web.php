...
Route::post('login', 'LoginController@ingreso')->name('login');

/* Route::post('login', ['middleware' => 'es_mayor_de_edad','uses' => 'LoginController@ingreso'])->name('login'); */

Route::view('nologin', 'noingresa');

Route::view('localizacion', 'localizacion')->name('localizacion');

Route::get('lang/{locale}', 'UbicacionController@index');
